...
int main(int argc, char *argv[])
{
    ...
    //OBAVEZNO POGLEDAJTE OVO! -- da bismo potenicijalno uklanili curenje memorije
    //delete world;
    //posto smo alocirali world koji je nasa klasa zar ne bi trebalo da ga ovde dealociramo sa hipa
